...
file_qtlColocReg_gwas <- paste(dir_gwas, "data/qtlColocReg_gwas.txt.gz", sep = '/')
file_gwasColocReg <- paste(dir_gwas, "data/gwasColocReg.txt.gz", sep = '/')
file_gwasRegTruncPthre <- paste(dir_gwas, "data/gwasRegTruncPthre.txt", sep = '/')
