...
for(gwasPhenocode in pheno_seq){
  ...
  dir_coloc_gwas <- "/project2/xuanyao/llw/coloc/ukbb_coloc_blood_traits/"
  
  file_qtlColocReg_gwas <- paste0(dir_coloc_gwas, "data/pheno", gwasPhenocode, ".qtlColocReg_gwas.txt.gz")
  file_gwasColocReg <- paste0(dir_coloc_gwas, "data/pheno", gwasPhenocode, ".gwasColocReg.txt.gz")
  file_resColoc <- paste0(dir_coloc_gwas, "data/pheno", gwasPhenocode, ".resColoc.txt.gz")
  ...
  for(reg in resColoc$Region){
    tryCatch({
      file_qtlVis <- paste0(dir_coloc_gwas, "colocVisData/pheno", gwasPhenocode, "_", reg, ".qtl.reg.coloc.txt")
      file_gwasVis <- paste0(dir_coloc_gwas, "colocVisData/pheno", gwasPhenocode, "_", reg, ".gwas.reg.coloc.txt")
      file_plt_vis <- paste0(dir_coloc_gwas, "plot/pheno", gwasPhenocode, "_", reg, ".reg.coloc.pdf")
      ...
      ## save vis -----
      ggsave(file_plt_vis, fig, width = 4, height = 3)
