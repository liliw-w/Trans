...
file_plot = paste0("pmid_all/traits.module.coloc.region.", pvalThre, ".order_by_n_coloc_trait.png")
file_plot_num = paste0("pmid_all/traits.module.coloc.region.", pvalThre, ".order_by_n_coloc_trait.png.txt")
...
saveRDS(fig_tile, 'fig4a_immune.rds')
ggsave(file_plot, fig_tile, width = 7.5, height = 7.5)
