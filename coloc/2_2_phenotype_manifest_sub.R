...
if(if_run_extract){
  ...
  ## powerful ukbb gwas (i.e. with large cases size of EUR)
  View(pheno_manifest %>%
...
ukbb_trait_phenocode <- c("30690", "30760",
                         ...
                         "300",
                         "185")
## multiple categorical, which should be specified coding
...
## write out interested traits -----
fwrite(pheno_manifest_subset, file_pheno_manifest_subset, quote = FALSE, sep = "\t")



# 2. download the extracted ukbb sum stat files -----
...
# 3. Visualize the sample sizes (controls & cases) from extracted traits -----
