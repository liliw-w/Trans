...
file_plot_chr <- paste0('plot/signal_chr_rm_infl_ratio_', ratio, '.pdf')
file_plot_module_chr <- paste0('plot/signal_module_chr_rm_infl_ratio_', ratio, '.pdf')
...
ggsave(file_plot_module, width = 10, height = 4)
...
ggsave(file_plot_module_chr, width = 12, height = 5)
