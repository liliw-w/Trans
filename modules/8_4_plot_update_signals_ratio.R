...
# I/O & paras -----
ratio_thre <- 50
file_signal <- paste0('postanalysis/signal_rm_infl_ratio_', ratio_thre, '.txt')

## output -----
file_plot_module <- paste0('plot/signal_module_rm_infl_ratio_', ratio_thre, '.pdf')
file_plot_chr <- paste0('plot/signal_chr_rm_infl_ratio_', ratio_thre, '.pdf')
file_plot_module_chr <- paste0('plot/signal_module_chr_rm_infl_ratio_', ratio_thre, '.pdf')
