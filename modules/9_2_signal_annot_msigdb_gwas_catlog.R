...
########### by msigdb pathway for modules ###########
########### and gwas catalog snp-trait/disease for signal snps ###########
##############################################
rm(list = ls())
library(data.table)
library(tidyverse)
...
## output -----
file_signal_annot <- "postanalysis/signal_cis_genes_w_annot_rm_infl_ratio_50.txt"
...
signal_cis_genes <- left_join(
  signal_cis_genes, coexp_module_annot,
  by = "module"
)
