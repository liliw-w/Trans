...
file_p <- paste0('/project2/xuanyao/llw/eQTLGen_est_Sigma/inflation/p_', basename(file_Sigma))
...
file_null_SNP <- '/project2/xuanyao/llw/eQTLGen_est_Sigma/null_SNP/num_nullSNP.rds'
