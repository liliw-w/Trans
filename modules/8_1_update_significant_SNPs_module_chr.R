...
## output -----
file_signal_rm_infl_ratio <- paste0('postanalysis/signal_rm_infl_ratio_', ratio_thre, '_module_chr.txt')
file_signal_uniq_rm_infl_ratio <- paste0('postanalysis/signal_uniq_rm_infl_ratio_', ratio_thre, '_module_chr.txt')
...
module_chr_use <- filter(ratio_module_chr, prop_dim_module_chr > ratio_thre) %>%
  distinct(module, SNPChr, prop_dim_module_chr)
