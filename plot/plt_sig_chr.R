...
file_qtl <- '~/xuanyao_llw/DGN_no_filter_on_mappability/FDR/signals.chr.module.perm10.fdr10.txt'


## output -----
file_plt_signal_module_chr_pos <- paste0('/project2/xuanyao/llw/DGN_no_filter_on_mappability/postanalysis/signal_module_chr_chr_pos.pdf')
