...
# gene_all = gene_annotation[match(names(coexp.module$moduleLabels), gene_annotation$GeneSymbol), Geneid]
...
save(mat_crossGene_module, mat_crossGene_chr, file = "crossGene.RData")
...
fig_crossGene <- ggplot(df_crossGene_module, aes(x = Module)) +
...
ggsave("plot/crossGene.png", fig_crossGene)
system("bash ~/imgcat plot/crossGene.png")
